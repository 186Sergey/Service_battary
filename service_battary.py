...
class DB:
    ...
    def insert_data(self,
        ...
        :param my_data: текущая дата
        :param gos_nomer: государственный номер автомобиля
        :param brend_auto: модель автомобиля
        :param brend_battary: ёмкость аккумуляторной батареи
        :param kol_battary: количество аккумуляторов, сданных на обслуживание
        ...
        my_data, gos_nomer, brend_auto, brend_battary, kol_battary, 
        description, density_do, density_posle ) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)''',
                       (my_data,
                        gos_nomer, brend_auto,
                        brend_battary, kol_battary,
                        description,
                        density_do,
                        density_posle))
        self.conn.commit()
