...
class Main(tk.Frame):
    ...
    def update_record(self,
        ...
        :return:
        """
        self.db.c.execute('''UPDATE battery SET mydata=?, gosnomer=?, brendauto=?, batterybrend=?, 
    ...
    def view_records(self):
        ...
        :return:
        """
        self.db.c.execute('''SELECT * FROM battery''')
    ...
    def delete_records(self):
        ...
        for selection_item in self.tree.selection():
            self.db.c.execute('''DELETE FROM battery WHERE id=?''',
    ...
    def search_records(self, gosnomer):
        ...
        """
        gosnomer = ('%' + gosnomer + '%',)
        self.db.c.execute('''SELECT * FROM battery WHERE gosnomer LIKE ?''', gosnomer)
        [self.tree.delete(i) for i in self.tree.get_children()]
        [self.tree.insert('', 'end', values=row) for row in self.db.c.fetchall()]
    ...
    def backupdb(self):
        ...
        with open("backup_battery.sql", "w") as f:
...
class Update(Child):
    ...
    def default_data(self):
        ...
        """
        self.db.c.execute('''SELECT * FROM battery WHERE id=?''',
